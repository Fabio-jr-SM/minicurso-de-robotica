...
inicio
	...
	enquanto(verdadeiro) farei{
		...
		} senao se ((Cor("sensorCorDir")=="Vermelho") e (Cor("sensorCorEsq")=="Vermelho")) entao {
			Esperar(10)
			Parar()

		} senao se ((Cor("sensorCorDir")=="Preto") e (Cor("sensorCorEsq")=="Preto") ou (Cor("sensorCorEsqExt")=="Preto") e (Cor("sensorCorDirExt")=="Preto")) entao {
